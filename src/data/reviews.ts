...
export const reviews: Review[] = [
  ...
  { slug: "woodpecker", name: "Woodpecker.co", category: "Marketing", tagline: "Cold email and LinkedIn outreach in one deliverability-focused workflow.", description: "Woodpecker combines cold email, LinkedIn steps, lead finding, email verification, warm-up, deliverability monitoring, and outbound integrations for teams running prospecting campaigns.", score: 9.1, price: "14-day or 100 cold-email trial; usage-based pricing varies", accent: "blue", bestFor: "B2B sales teams, agencies, and founders running structured outbound", pros: ["Combines email and LinkedIn sequences", "Strong deliverability controls", "Lead finding and verification tools", "API, webhooks, MCP, and CLI options", "Agency features available"], cons: ["Outbound compliance and consent remain the user's responsibility", "Usage-based pricing requires careful volume planning", "LinkedIn automation should be used within platform rules"], features: ["Cold email campaigns", "LinkedIn outreach", "Free warm-up", "Catch-all verification", "Deliverability monitor", "CRM and automation integrations"], affiliateUrl: "https://woodpecker.co/?red=hhgg", updated: "September 2026" },
]
